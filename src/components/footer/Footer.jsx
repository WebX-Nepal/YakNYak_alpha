        ...
        <>
            <div className="footer-bg  bg-black/80 h-full w-full px-4 xl:px-[120px] " style={{ backgroundImage: `url(${footer})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }}>
                <div className="content h-full w-full">
                    <div className=" flex flex-wrap justify-center items-start pt-10 xl:pt-24 text-white gap-10">
                        <div className="item w-full xl:w-[30%]">
                            <div className="logo">
                                <img src={logo} alt="" className="mr-16 w-[100px]" />
                            </div>
                            <p className='mt-10 text-gray-400 font-bold'>"Beer, a timeless elixir, intertwines craftsmanship and conviviality in every effervescent sip."</p>

                        </div>
                        <div className="item w-full xl:w-[30%]">
                            <h2 className='font-bold text-[2em] text-[#e6bf55]'>Contact info</h2>
                            <div className="flex items-center gap-5 mt-3 xl:mt-8">
                        ...
                        <div className="item w-full xl:w-[30%] ">
                            ...
                            <ul className="social-media flex gap-10 text-white text-[1.5em] mt-2 xl:mt-10">
                    ...
                    <hr className='mt-10 xl:mt-24 border-[#454545]' />
                    <img src={beerIcon} alt="imgerr" className='h-16 absolute right-2 xl:right-10 mt-[-17px] animate-bounce' />


                    <div className="copyright mt-6 xl:px-[20px] pb-7 flex justify-between items-center">
                        <h5 className='font-bold text-white w-[70%] sm:w-full'><span className='text-[#e6bf55] font-normal'>Like-themes</span> © All Rights Reserved - 2019 - <span className='text-[#e6bf55] font-normal'>Purchase</span></h5>
