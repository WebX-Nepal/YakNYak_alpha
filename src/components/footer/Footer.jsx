...
const Footer = () => {
    return (
        <>
            <div className="footer-bg  bg-black/80 h-full w-full px-[120px] " style={{ backgroundImage: `url(${footer})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }}>
