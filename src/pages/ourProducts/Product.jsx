...
const Product = () => {
  return (
    <>
      <div className="about-bg brightness-50 h-[40vh] w-full" style={{ backgroundImage: `url(${product})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }}>
      </div>

      <div className="flex gap-20 px-[140px] items-center justify-center">
        <div className="image">
          <img src={beer} alt="" srcset="" className='h-[800px] ' />
        </div>
      ...
      <div className="divider bg-[#252362] flex justify-center items-center h-full w-full px-[140px] py-16">
        <div className="icon-container w-[50%]">
          <div className="item gap-20 flex">
            <div className="one">
              <img src={icon1} alt="" srcset="" className="h-12 m-auto" />
              <h2 className="font-bold text-white mt-3">Unique Yeast</h2>
            </div>
            <div className="two">
              <img src={icon2} alt="" srcset="" className="h-12 m-auto" />
              <h2 className="font-bold text-white mt-3">Perennial Recipes</h2>
            </div>
            <div className="three">
              <img src={icon3} alt="" srcset="" className="h-12 m-auto" />
          ...
          <div className="item flex gap-24 mt-10">
            <div className="one">
              <img src={icon4} alt="" srcset="" className="h-12 m-auto" />
              <h2 className="font-bold text-white mt-3">Selected Malts</h2>
            </div>
            <div className="two">
              <img src={icon5} alt="" srcset="" className="h-12 m-auto" />
              <h2 className="font-bold text-white mt-3">Quality Hops</h2>
            </div>
            <div className="three">
              <img src={icon6} alt="" srcset="" className="h-12 m-auto" />
              <h2 className="font-bold text-white mt-3">Special Water</h2>
            </div>
          </div>
        </div>
        <div className="image w-[40%]">
          <img src={beer_2} alt="" srcset="" />
        </div>
      </div>

      <div className="flex mt-[-.9em] justify-center w-full">
        <img src={party1} alt="imgerr" srcset="" className='w-full h-[70vh] object-cover' />
        <img src={party2} alt="imgerr" srcset="" className='w-full h-[70vh] object-cover' />
      </div>

      <div className="moon-divider px-[140px] py-28 bg-[#252362] mb-[-6.9em] ">
        <img src={moon} alt="" srcset="" className='' />
        <div className="text flex justify-end items-center gap-2 tracking-wider mt-28">
          ...
          <img src={logo} alt="" srcset="" className='h-20' />
        </div>
      </div>
